...
class LowOutstandingStrategy(BaseScheduleStrategy):
    ...
    def __init__(self, start, period, stock_amount, init_cap, send_mail=1, source='mongo'):
        super(LowOutstandingStrategy, self).__init__(start, period, stock_amount, init_cap, send_mail, source)
...
if __name__ == '__main__':
    ...
    if len(sys.argv) == 6:
        send_mail = int(sys.argv[4])
        source = sys.argv[5]
    s = LowOutstandingStrategy(start='2016-08-30', period=int(sys.argv[1]), stock_amount=int(sys.argv[2]),
